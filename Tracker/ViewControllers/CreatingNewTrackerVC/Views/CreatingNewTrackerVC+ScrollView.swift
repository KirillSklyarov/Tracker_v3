...
extension CreatingNewTrackerViewController {
    ...
    func setupContentStack() {
        ...
        [textFieldViewStack, contentStackView, tableView,
         emojiCollection, colorsCollection, buttonsStack].forEach { $0.translatesAutoresizingMaskIntoConstraints = false
        }

        [textFieldViewStack, tableView, emojiCollection,
         colorsCollection, buttonsStack].forEach { contentStackView.addArrangedSubview($0) }
